...
let vehicle: Vehicle = new Vehicle("Lada", "2210", new Date(), "3hdb37fhsbfh3bdbr", "e168va56", owner);
...
let motorbike: Motorbike = new Motorbike("Yamaha", "228", new Date(), "1234567890qwertyw", "a228ye228", "Hard", true, owner);
